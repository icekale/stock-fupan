...
export function WatchlistImportPanel({
  ...
  return (
    <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <textarea
        className="mt-3 min-h-28 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-950 shadow-sm transition hover:border-slate-300"
        value={content}
      ...
      <div className="mt-3 grid gap-2 sm:grid-cols-3">
        ...
        <label className="cursor-pointer rounded-xl border border-slate-200 px-4 py-2.5 text-center text-sm font-bold text-slate-700 transition hover:border-slate-300 hover:bg-slate-50 active:translate-y-px">
          上传文件
      ...
      {ocrPreview && (
        <div className="mt-3 rounded-xl border border-amber-200 bg-amber-50 p-3 text-xs leading-6 text-amber-900">
          ...
          <button
            className="mt-3 w-full rounded-xl bg-amber-600 px-4 py-2.5 text-sm font-bold text-white transition hover:bg-amber-700 active:translate-y-px disabled:cursor-not-allowed disabled:bg-amber-300 disabled:active:translate-y-0"
